...
- `20260825100000_add_ai_home_context.sql`: Ana sayfa AI özeti için aktif dönem ve kullanıcı rolüne göre filtrelenmiş kesin veri bağlamı üretir. Uzun/gizli metinleri, bütçe ve sponsor verilerini dışarıda bırakır; AI kapalıyken RPC de kapalıdır.
- `20260825110000_add_ai_quota_reservation.sql`: Gemini çağrısından önce proje/model ve kullanıcı günlük sınırlarını eş zamanlı isteklerde de güvenli biçimde rezerve eder; sonuç token/hata sayaçlarını yalnızca service-role günceller.
