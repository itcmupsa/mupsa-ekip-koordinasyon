...
- Günlük özet Flash-Lite'a taşındı. Derin analiz için ayrılan Gemini 3.7 Flash uygulama kotası dönem genelinde günde 6 istekle, yüksek hacimli Flash-Lite işlemleri ise günde 100 uygulama rezervasyonuyla sınırlandırıldı; sağlayıcı kotası daha önce dolarsa ikincil proje anahtarı denenir ve sonrasında API'siz güvenli yedek çalışır. Normal ana sayfa kullanımı 24 saat önbelleğe alınır; büyük manuel yenileme düğmesi kaldırıldı.
...
- Model yönlendirme v4 kararı: günlük özet, normal sohbet, kısa taslak, manuel takvim sınıflandırması ve önemli gün önerileri `gemini-3.5-flash-lite`; takvim dahil derin dönem analizi, haftalık yönetim analizi ve çok kaynaklı kurumsal hafıza sentezi `gemini-3.7-flash` kullanır. 3.7 normal sohbet mesajlarında kullanılmaz ve uygulama içi günlük kotası düşük tutulur.
