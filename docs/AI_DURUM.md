...
- Google ücretsiz katmanındaki 20 RPD sınırına güvenlik payı bırakmak için uygulama Flash kotası 12 RPD'ye indirildi. Normal ana sayfa kullanımı önbellek nedeniyle kullanıcı başına günde yaklaşık bir üretim çağrısı hedefler; büyük manuel yenileme düğmesi kaldırıldı.
